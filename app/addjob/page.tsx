...
function Addjob() {
    ...
    async function handleSubmit(){
        if(url==='' || company ==='' ||domain ==='' ||location===''||role === '' || submitter==='' || emailSubmitter==='' ){
            setType('error')
                    ...
                    <div className="bg-background-1 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div className="mb-2">
                            <label className="block text-gray-700 text-sm font-bold mb-1">
                                Link to this job <span className="star text-hazard">*</span>
                            </label>
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-1">
                                Job title <span className="star text-hazard">*</span>
                            </label>
                            <input value={role} onChange={(e)=>setRole(e.target.value)} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline" id="company" type="text" placeholder="software developer"/>
                                <p className="text-red-500 text-xs italic">Please role (like software developer)</p>
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-1">
                                Company Name <span className="star text-hazard">*</span>
                            </label>
                            <input value={company} onChange={(e)=>setCompany(e.target.value)} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline" id="company" type="text" placeholder="Microsoft"/>
                                <p className="text-red-500 text-xs italic">Please enter the company</p>
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-1">
                                Job Location <span className="star text-hazard">*</span>
                            </label>
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-1">
                                Work Model <span className="star text-hazard">*</span>
                            </label>
                            <select id="work_modle" name="work model"
                                className="shadow border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline"
                                onChange={(e)=>setDomain(e.target.value)}>
                                <option value="onsite">Onsite</option>
                                <option value="remote">Remote</option>
                                <option value="hybrid">Hybrid</option>
                            </select> 
                            <p className="text-red-500 text-xs italic">Please select work model.</p>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex">
                                <div className="mr-2">
                                    <input value={submitter} onChange={(e)=>setSubmitter(e.target.value)} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline" id="thumbnailurl" type="text" placeholder="https://hydroottawa.com/themes/custom/hydro/favicon.ico"/>
                                    <p className="text-red-500 text-sm">Name</p>
                                </div>
                                <div className="ml-2">
                                    <input value={emailSubmitter} onChange={(e)=>setEmailSubmitter(e.target.value)} className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline" id="thumbnailurl" type="text" placeholder="https://hydroottawa.com/themes/custom/hydro/favicon.ico"/>
                                    <p className="text-red-500 text-sm">email</p>
                                </div>
                            </div>
                            <p className="text-red-500 text-xs italic">Your name and email will not be shown in the job listing.</p>
                        </div>
